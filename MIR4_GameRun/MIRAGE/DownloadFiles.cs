  ...
  public class DownloadFiles : Window, IComponentConnector
  {
    ...
    public void Download()
    {
      try
      {
        ...
        string str1 = this._localPath + this._tempPath + path;
        string str2 = this._localPath + "\\" + path;
        if (str1.LastIndexOf("/") > 0)
        {
          DirectoryInfo directoryInfo1 = new DirectoryInfo(str1.Substring(0, str1.LastIndexOf('/')));
          if (!directoryInfo1.Exists)
            directoryInfo1.Create();
          if ("1".Equals(this._type))
          {
            DirectoryInfo directoryInfo2 = new DirectoryInfo(str2.Substring(0, str2.LastIndexOf('/')));
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/MIR4_GameRun;component/downloadfiles.xaml", UriKind.Relative));
    }
